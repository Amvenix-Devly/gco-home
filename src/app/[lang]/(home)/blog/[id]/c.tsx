      ...
      <div className="w-full space-y-4">
        ...
        {/* <div>
          <p className="leading-6">
            When trees are planted in the right place, at the right time, and
            for the right reasons, they can help address many of the
            environmental and social challenges we face. Learn more
          </p>
        </div> */}
        <div>
          ...
          <ul className="[&>li]:opacity-50 [&>li]:text-sm [&>*]:ml-2 checklist">
            ...
            <li>
              Restore critical habitat for the millions of species that depend
              on forests
            </li>
            <li>
        ...
        <div className="border border-main p-3 w-[100%] space-y-3">
        ...
        <div className=" pb-5 border-stone-400">
          <p className="text-xs">
